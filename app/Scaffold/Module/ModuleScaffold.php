...
namespace FilsKuwait\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use FilsKuwait\Scaffold\Module\Generators\FilesGenerator;
use FilsKuwait\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \FilsKuwait\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \FilsKuwait\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \FilsKuwait\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \FilsKuwait\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The FilsKuwait {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The FilsKuwait {$moduleName} Module.\"," . PHP_EOL;
