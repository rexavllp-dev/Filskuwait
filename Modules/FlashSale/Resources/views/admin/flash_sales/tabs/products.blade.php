...
@push('globals')
    <script>
        FilsKuwait.data['flash_sale.products'] = {!! old_json('products', $flashSale->products) !!};
        FilsKuwait.errors['flash_sale.products'] = @json($errors->get('products.*'), JSON_FORCE_OBJECT);
    </script>
@endpush
