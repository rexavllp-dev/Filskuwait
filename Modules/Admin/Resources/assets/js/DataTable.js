...
FilsKuwait.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (FilsKuwait.dataTable.selected[selector] === undefined) {
            FilsKuwait.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (! FilsKuwait.dataTable.selected[this.selector].includes(id)) {
            FilsKuwait.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        FilsKuwait.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = FilsKuwait.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return FilsKuwait.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        FilsKuwait.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        FilsKuwait.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return FilsKuwait.dataTable.selected[selector];
    }
