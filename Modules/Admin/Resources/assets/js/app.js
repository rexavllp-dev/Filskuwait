...
$(function () {
    ...
    var o = $.FilsKuwait.options;

    // Set up the object
    _init();

    // Activate layout
    $.FilsKuwait.layout.activate();

    // Enable sidebar tree view controls
    if (o.enableControlTreeView) {
        $.FilsKuwait.tree('.sidebar');
    }

    // Activate sidebar push menu
    if (o.sidebarPushMenu) {
        $.FilsKuwait.pushMenu.activate(o.sidebarToggleSelector);
    }
...
/* ----------------------------------
   - Initialize the FilsKuwait Object -
   ---------------------------------- */
function _init() {
    ...
    $.FilsKuwait.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.FilsKuwait.options.screenSizes;
    ...
    // Tree
    $.FilsKuwait.tree = function (menu) {
        var animationSpeed = $.FilsKuwait.options.animationSpeed;
