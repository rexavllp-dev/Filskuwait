...
if (! function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('filskuwait.modules.core.config.core_modules'));
    }
}
...
if (! function_exists('filskuwait_version')) {
    /**
     * Get the filskuwait version.
     *
     * @return string
     */
    function filskuwait_version()
    {
        return FilsKuwait::VERSION;
    }
}
