...
class Permission
{
    ...
    private static function getEnabledModulePermissions()
    {
        ...
        foreach (Module::allEnabled() as $module) {
            $config = config('filskuwait.modules.' . strtolower($module->getName()) . '.permissions');
    ...
    {
        $permissions = config('filskuwait.themes.' . strtolower(setting('active_theme')) . '.permissions');
